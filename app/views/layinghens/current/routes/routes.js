...
const serviceName =
	'Check if you can apply for a Farming Transformation Fund slurry acidification grant'
...
router.post('/planning-required-condition-answer', function (req, res) {
	var planningRequiredCondition =
		req.session.data['planning-required-condition']
...
router.post('/hen-project-type-answer', function (req, res) {
	...
	} else if (henProjectType == 'refurb' || henProjectType == 'replace') {
		res.redirect('hen-building-items')
...
router.post('/hen-refurbishing-answer', function (req, res) {
	...
	if (henRefurbishing == 'replace' || henRefurbishing == 'refurbish') {
		res.redirect('hen-building-items')
	} else {
		res.redirect('kickout')
	}
...
router.post('/pullet-housing-requirements-answer', function (req, res) {
	var pulletHousingRequirements =
		req.session.data['pullet-housing-requirements']
...
router.post('/pullet-ventilation-features-answer', function (req, res) {
	var pulletVentilationFeatures =
		req.session.data['pullet-ventilation-features']
...
router.post('/pullet-veranda-specification-answer', function (req, res) {
	var pulletVerandaSpecification =
		req.session.data['pullet-veranda-specification']
...
router.post('/pullet-veranda-requirements-answer', function (req, res) {
	var pulletVerandaRequirements =
		req.session.data['pullet-veranda-requirements']
...
router.post('/pullet-environmental-data-type-answer', function (req, res) {
	var pulletEnvironmentalDataType =
		req.session.data['pullet-environmental-data-type']
