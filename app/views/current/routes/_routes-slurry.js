...
router.get('*/slurry/farming-type-answer', function (req, res) {
  ...
  if (farmingType == "no"){res.redirect('../slurry/farming-type-fail')}
  else {
    if ( req.session.data['slurry_s01_status'] == 'Completed'){
...
router.post('*/slurry/legal-status-answer', function (req, res) {
  ...
  if (legalStatus == "none"){res.redirect('../slurry/legal-status-fail')}
  else {
...
router.post('*/slurry/tenancy-length-answer', function (req, res) {
  ...
  if (tenancyLength == "no"){res.redirect('../slurry/tenancy-length-condition')}
  else {
    if ( req.session.data['slurry_s01_status'] == 'Completed'){
      res.redirect('../slurry/check-answers-check-you-can-apply')
    }else{
...
router.post('*/slurry/project-cost-answer', function (req, res) {
  ...
  if (projectCost < 87500 ){res.redirect('../slurry/project-cost-fail')}
  else {
...
router.post('*/slurry/remaining-costs-answer', function (req, res) {
  ...
  if (remainingCosts == "no" ){res.redirect('../slurry/remaining-costs-fail')}
  else {
...
router.post('*/slurry/project-start-answer', function (req, res) {
  ...
  if (projectStart == "yes"){res.redirect('../slurry/project-start-fail')}
  else {
    if ( req.session.data['slurry_s01_status'] == 'Completed'){
      res.redirect('../slurry/check-answers-check-you-can-apply')
    }else{
...
router.post('*/slurry/planning-required-answer', function (req, res) {
  ...
  if (planningRequired == "not sure"){res.redirect('../slurry/planning-required-condition')}
  else {
    if ( req.session.data['slurry_s01_status'] == 'Completed'){
      res.redirect('../slurry/check-answers-check-you-can-apply')
    }else{
...
router.post('*/slurry/planning-permission-answer', function (req, res) {
  ...
  if (planningPermission == "yes"){res.redirect('../slurry/check-answers-check-you-can-apply')}
  else {res.redirect('../slurry/planning-progress')}
});
...
router.post('*/slurry/planning-progress-answer', function (req, res) {
  ...
  if (planningProgress == "not sure"){res.redirect('../slurry/planning-progress-condition')}
  else {res.redirect('../slurry/planning-permission-fail')}
});
...
router.post('*/slurry/business-answer', function (req, res) {
  ...
  if (businessAnswer == "no"){res.redirect('../slurry/new-business-condition')}
  else {res.redirect('../slurry/applying')}
});
...
router.post('*/slurry/applying-answer', function (req, res) {
  ...
  if (applyingAnswer == "other"){res.redirect('../slurry/preferred-contact')}
  else {res.redirect('../slurry/your-details')}
});
...
router.post('*/slurry/your-details-answer', function (req, res) {
  ...
  if (applyingAnswer == "other"){res.redirect('../slurry/applicant-details')}
  else {res.redirect('../slurry/check-answers-contact-details')}
});
...
router.post('*/slurry/preferred-contact-answer', function (req, res) {
  ...
  if (preferredContact == "just the applicant"){res.redirect('../slurry/applicant-details')}
  else {res.redirect('../slurry/your-details')}
});
